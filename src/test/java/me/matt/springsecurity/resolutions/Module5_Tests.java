...
public class Module5_Tests {
    ...
    static class OpaqueTokenPostProcessor {
        ...
        void introspector(OpaqueTokenIntrospector introspector) throws Exception {
            ...
            if (introspector instanceof NimbusOpaqueTokenIntrospector) {
                ...
                Field delegate =
                        ReflectionSupport.getDeclaredFieldByType(UserRepositoryOpaqueTokenIntrospector.class, OpaqueTokenIntrospector.class);
                if (delegate == null) {
                    delegate = ReflectionSupport.getDeclaredFieldByType(UserRepositoryOpaqueTokenIntrospector.class, NimbusOpaqueTokenIntrospector.class);
                }
                if (delegate != null) {
    ...
    public void task_4() throws Exception {
        ...
        Field nameField = ReflectionSupport.getDeclaredFieldByColumnName(User.class, "subscription");
        assertNotNull(
        ...
        Field friendsField = ReflectionSupport.getDeclaredFieldByName(User.class, "friends");
        assertNotNull(
